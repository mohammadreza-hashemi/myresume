...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li><a href="/admin/users">کاربران <span class="badge badgeuser" id="badgeuser">0</span></a></li>
            ...
            <ul class="nav nav-sidebar">
              @cannot('developer')
                ...
                <li><a href="/admin/comment/unsuccessful">نظرات تایید نشده <span class="badge">{{$commentunsuccessfulcount}}</span></a></li>
              @endcannot
